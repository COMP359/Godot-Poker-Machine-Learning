...
class TestRoyalFlushTie:
	...
	func test_royal_flush_case_one():
		...
		gameCycle.players[0].hand.add_mulitple_cards(player_one_hand_cards)

		gameCycle.players[0].hand.ranking.determine_hand_ranking(dealer_hand_cards + player_one_hand_cards)

		var player_tied: Array[Player] = [gameCycle.players[0]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.ROYAL_FLUSH), [gameCycle.players[0]])
...
class TestStraightFlushTie:
	...
	func before_each():
		...
		gameCycle.dealer.community_cards.clear_hand()
		gameCycle.players[0].hand.clear_hand()
		gameCycle.players[1].hand.clear_hand()
		gameCycle.players[2].hand.clear_hand()
		gameCycle.players[3].hand.clear_hand()
	...
	func test_straight_flush_case_one():
		...
		dealer_hands.add_mulitple_cards(dealer_hand_cards)
		gameCycle.players[0].hand.add_mulitple_cards(player_one_hand_cards)
		gameCycle.players[1].hand.add_mulitple_cards(player_two_hand_cards)

		gameCycle.players[0].hand.ranking.determine_hand_ranking(dealer_hand_cards + player_one_hand_cards)
		gameCycle.players[1].hand.ranking.determine_hand_ranking(dealer_hand_cards + player_two_hand_cards)

		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.STRAIGHT_FLUSH), [gameCycle.players[1]])
	...
	func test_straight_flush_case_two():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.STRAIGHT_FLUSH), [gameCycle.players[0], gameCycle.players[1]])
	...
	func test_straight_flush_case_three():
		...
		gameCycle.players[0].hand.add_mulitple_cards(player_one_hand_cards)
		gameCycle.players[1].hand.add_mulitple_cards(player_two_hand_cards)
		gameCycle.players[2].hand.add_mulitple_cards(player_three_hand_cards)

		gameCycle.players[0].hand.ranking.determine_hand_ranking(dealer_hand_cards + player_one_hand_cards)
		gameCycle.players[1].hand.ranking.determine_hand_ranking(dealer_hand_cards + player_two_hand_cards)
		gameCycle.players[2].hand.ranking.determine_hand_ranking(dealer_hand_cards + player_three_hand_cards)

		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1], gameCycle.players[2]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.STRAIGHT_FLUSH), [gameCycle.players[2]])
	...
	func test_straight_flush_case_four():
		...
		gameCycle.players[1].hand.add_mulitple_cards(player_two_hand_cards)
		gameCycle.players[2].hand.add_mulitple_cards(player_three_hand_cards)
		gameCycle.players[3].hand.add_mulitple_cards(player_four_hand_cards)

		gameCycle.players[0].hand.ranking.determine_hand_ranking(dealer_hand_cards + player_one_hand_cards)
		gameCycle.players[1].hand.ranking.determine_hand_ranking(dealer_hand_cards + player_two_hand_cards)
		gameCycle.players[2].hand.ranking.determine_hand_ranking(dealer_hand_cards + player_three_hand_cards)
		gameCycle.players[3].hand.ranking.determine_hand_ranking(dealer_hand_cards + player_four_hand_cards)

		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1], gameCycle.players[2], gameCycle.players[3]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.STRAIGHT_FLUSH), [gameCycle.players[0], gameCycle.players[1], gameCycle.players[2], gameCycle.players[3]])
...
class TestStraightTie:
	...
	func test_straight_case_one():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.STRAIGHT), [gameCycle.players[1]])
	...
	func test_straight_case_two():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.STRAIGHT), [gameCycle.players[0], gameCycle.players[1]])
	...
	func test_straight_case_three():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1], gameCycle.players[2]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.STRAIGHT), [gameCycle.players[2]])
...
class TestFourOfKindTie:
	...
	func test_four_of_kind_case_one():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.FOUR_OF_A_KIND), [gameCycle.players[0]])
	...
	func test_four_of_kind_case_two():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.FOUR_OF_A_KIND), [gameCycle.players[1]])
	...
	func test_four_of_kind_case_three():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.FOUR_OF_A_KIND), [gameCycle.players[0], gameCycle.players[1]])
...
class TestThreeOfKindTie:
	...
	func test_three_of_kind_case_one():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.THREE_OF_A_KIND), [gameCycle.players[0], gameCycle.players[1]])
	...
	func test_three_of_kind_case_two():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.THREE_OF_A_KIND), [gameCycle.players[1]])
...
class TestFlushTie:
	...
	func test_flush_case_one():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.FLUSH), [gameCycle.players[1]])
	...
	func test_flush_case_two():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.FLUSH), [gameCycle.players[0],gameCycle.players[1]])
	...
	func test_flush_case_three():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.FLUSH), [gameCycle.players[0]])
...
class TestFullHouseTie:
	...
	func test_full_house_case_one():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.FULL_HOUSE), [gameCycle.players[1]])
	...
	func test_full_house_case_two():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.FULL_HOUSE), [gameCycle.players[0]])
	...
	func test_full_house_case_four():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.FULL_HOUSE), [gameCycle.players[0], gameCycle.players[1]])
	...
	func test_full_house_case_six():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1], gameCycle.players[2]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.FULL_HOUSE), [gameCycle.players[2]])
...
class TestTwoPairTie:
	...
	func test_two_pair_case_one():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.TWO_PAIR), [gameCycle.players[0]])
	...
	func test_two_pair_case_three():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.TWO_PAIR), [gameCycle.players[0], gameCycle.players[1]])
	...
	func test_two_pair_case_four():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.TWO_PAIR), [gameCycle.players[1]])
	...
	func test_two_pair_case_six():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1], gameCycle.players[2], gameCycle.players[3]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.TWO_PAIR), [gameCycle.players[2]])
...
class TestOnePairTie:
	...
	func test_one_pair_case_one():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.PAIR), [gameCycle.players[0]])
	...
	func test_one_pair_case_two():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.PAIR), [gameCycle.players[1]])
	...
	func test_one_pair_case_three():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.PAIR), [gameCycle.players[0], gameCycle.players[1]])
	...
	func test_one_pair_case_five():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1], gameCycle.players[2], gameCycle.players[3]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.PAIR), [gameCycle.players[2]])
	...
	func test_one_pair_case_six():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1], gameCycle.players[2]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.PAIR), [gameCycle.players[1], gameCycle.players[2]])
	...
	func test_one_pair_case_seven():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1], gameCycle.players[2], gameCycle.players[3]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.PAIR), [gameCycle.players[0], gameCycle.players[1], gameCycle.players[2], gameCycle.players[3]])
...
class TestHighCardTie:
	...
	func test_high_card_case_one():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.HIGH_CARD), [gameCycle.players[1]])
	...
	func test_high_card_case_two():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.HIGH_CARD), [gameCycle.players[0]])
	...
	func test_high_card_case_four():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.HIGH_CARD), [gameCycle.players[0], gameCycle.players[1]])
	...
	func test_high_card_case_five():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1], gameCycle.players[2], gameCycle.players[3]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.HIGH_CARD), [gameCycle.players[2]])
	...
	func test_high_card_case_seven():
		...
		var player_tied: Array[Player] = [gameCycle.players[0], gameCycle.players[1], gameCycle.players[2], gameCycle.players[3]]
		assert_eq(utils.determine_tie(player_tied, Rank.RankEnum.HIGH_CARD), [gameCycle.players[0], gameCycle.players[2]])
